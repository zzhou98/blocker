...
package com.merxury.blocker.feature.ruledetail.impl.component
    ...
    Column(
        ...
        MarkdownText(
            ...
            markdown = if (rule.description.isNullOrBlank()) {
                stringResource(id = ruledetailString.feature_ruledetail_api_no_description)
            } else {
        ...
        InfoItemHeading(
            ...
            description = listOf(
                when (rule.safeToBlock) {
                    null -> stringResource(id = ruledetailString.feature_ruledetail_api_unknown)
                    true -> stringResource(id = ruledetailString.feature_ruledetail_api_yes)
                    false -> stringResource(id = ruledetailString.feature_ruledetail_api_no)
                },
            ),
        )
        InfoItemHeading(
            heading = stringResource(id = ruledetailString.feature_ruledetail_api_side_effect),
            description = listOf(
                rule.sideEffect ?: stringResource(id = ruledetailString.feature_ruledetail_api_unknown),
            ),
        )
        InfoItemHeading(
            heading = stringResource(id = ruledetailString.feature_ruledetail_api_keywords),
            description = rule.searchKeyword,
        )
        InfoItemHeading(
            heading = stringResource(id = ruledetailString.feature_ruledetail_api_contributors),
