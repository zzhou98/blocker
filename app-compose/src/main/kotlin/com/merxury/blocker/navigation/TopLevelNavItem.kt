...
val FIREWALL = TopLevelNavItem(
    selectedIcon = Icon.ImageVectorIcon(BlockerIcons.Shield),
    unselectedIcon = Icon.ImageVectorIcon(BlockerIcons.Shield),
    iconTextId = R.string.firewall,
    titleTextId = R.string.firewall,
)
